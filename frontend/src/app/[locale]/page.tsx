        ...
        <section className="bg-purple-600 py-16 sm:py-20">
          <div className="mx-auto max-w-6xl px-4">
            <div className="grid gap-8 sm:grid-cols-3 text-center">
              {[
                { icon: Package, value: communityStats.totalItems, label: "Items Shared", suffix: "+" },
                { icon: Users, value: communityStats.totalMembers, label: "Community Members", suffix: "+" },
                { icon: ArrowRightLeft, value: communityStats.activeBorrows, label: "Successful Borrows", suffix: "+" },
