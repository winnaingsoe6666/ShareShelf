...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 relative overflow-hidden font-body">
      ...
      <div className="relative w-full max-w-sm bg-white/1 backdrop-blur-2xl border border-white/20 shadow-[0_24px_50px_rgba(0,0,0,0.30)] rounded-3xl p-6 sm:p-8 transition-all duration-500 hover:shadow-purple-500/10 hover:border-white/30 animate-slide-up z-10">
